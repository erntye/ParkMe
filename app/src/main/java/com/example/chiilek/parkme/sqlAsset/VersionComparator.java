...
import com.example.chiilek.parkme.sqlAsset.SQLiteAssetHelper.SQLiteAssetException;
...
class VersionComparator implements Comparator<String> {
    ...
    private static final String TAG = com.example.chiilek.parkme.sqlAsset.SQLiteAssetHelper.class.getSimpleName();
