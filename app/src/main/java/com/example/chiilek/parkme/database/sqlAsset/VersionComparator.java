...
import com.example.chiilek.parkme.database.sqlAsset.SQLiteAssetHelper.SQLiteAssetException;
...
class VersionComparator implements Comparator<String> {
    ...
    private static final String TAG = com.example.chiilek.parkme.database.sqlAsset.SQLiteAssetHelper.class.getSimpleName();
